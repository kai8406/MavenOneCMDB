...
public class MultiSelectCI extends LayoutContainer implements Listener<SelectionChangedEvent>, IValueComponent<List<CIModel>> {
	...
	public List<CIModel> getValue() {
		return(this.selected);
	}


	public void setValue(List<CIModel> value) {
		// TODO:::
	}
}
