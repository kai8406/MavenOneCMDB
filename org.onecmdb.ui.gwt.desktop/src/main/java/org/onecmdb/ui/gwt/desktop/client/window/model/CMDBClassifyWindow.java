...
public class CMDBClassifyWindow extends CMDBAbstractWidget {

	public static final String ID = "cmdb-model-classify";

	public CMDBClassifyWindow(CMDBDesktopWindowItem item) {
		super(item);
	}
	...
	public WidgetDescription getDescription() {
		...
		desc.setId(ID);
		desc.setName("Classify OneCMDB Instances");
		desc.setDescription("Classify, move instances/templates to different parent templates.");
		desc.addParameter("rootCi - the root ci to start on.");
		return(desc);
	}
}
