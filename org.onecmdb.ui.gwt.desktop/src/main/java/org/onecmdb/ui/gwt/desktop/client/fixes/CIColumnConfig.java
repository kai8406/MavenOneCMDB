...
public class CIColumnConfig extends ColumnConfig implements ComponentPlugin {

	private Grid grid;
	private AttributeColumnConfig config;
	private CMDBPermissions permissions;

	public CIColumnConfig() {
		super();
		init();
	}
	public CIColumnConfig(AttributeColumnConfig config) {
		super();
		this.config = config;
		init();
	}
	public CIColumnConfig(String id, String name, int width) {
		super(id, name, width);
		init();
	}
