...
public class RegistrationWindow extends CMDBAbstractWidget {
	public static final String ID = "cmdb-registration-widget";
	
	public RegistrationWindow(CMDBDesktopWindowItem item) {
		super(item);
	}
