...
public class NewDateTimeFieldWidget extends NewMaskTextFieldWidget implements KeyboardListener, IBaseField {
	...
	public void onKeyUp(Widget sender, char keyCode, int modifiers) {
		// Update value.
		this.value.setValue(((TextBoxBase)getBaseField()).getText());
		validate();
	}
