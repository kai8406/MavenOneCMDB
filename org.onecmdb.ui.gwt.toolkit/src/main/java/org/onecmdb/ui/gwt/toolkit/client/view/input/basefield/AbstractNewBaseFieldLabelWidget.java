...
public abstract class AbstractNewBaseFieldLabelWidget extends BaseFieldLabelWidget implements IBaseField {

	public AbstractNewBaseFieldLabelWidget(String labelText) {
		super(labelText);
	}
