...
create index id_path_ci_idx on CI (id, path(1024));
create index path_ci_idx on CI (path(1024));
...
create index valueAsString_atr_idx on Attribute (valueAsString(1024));
