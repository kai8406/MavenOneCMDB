 ...
 */
package org.onecmdb.ui.gwt.itil.client.application.problem.control;
...
public class NewProblemControl extends CIAttributeValueInputControl {
	
	
	public NewProblemControl(String templateAlias, boolean isNew) {
		super(templateAlias, isNew);
	}

	public NewProblemControl(GWT_CiBean bean) {
		super(bean);
	}
