...
/**
 * <code>QueryQriteria</code> is used to search OneCmdb for CI's<br>
 * <br>
 * Supports query for
 * <ul>
...
public class QueryCriteria<E> {
	...
	public String getMatchAttributeAlias() {
		return(this.attrAlias);
	}
	
	public void setMatchAttributeAlias(String attrAlias) {
