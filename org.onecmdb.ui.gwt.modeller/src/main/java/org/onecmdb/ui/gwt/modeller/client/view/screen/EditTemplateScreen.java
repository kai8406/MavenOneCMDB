...
public class EditTemplateScreen extends AddTemplateScreen {
	...
	public EditTemplateScreen() {
		super();
		setTitleText("Edit Template");
		aFilter.setIsNew(false);
	}
	...
	protected void onCommitSuccess(Object result) {
		...
		if (result instanceof GWT_CiBean) {
			TemplateCache.remove(((GWT_CiBean)result).getAlias());
		}
	}
